...
set CLASSPATH=%APP_HOME%\lib\java-demo.jar;%APP_HOME%\lib\guava-23.0.jar;%APP_HOME%\lib\javaparser-core-3.6.26.jar;%APP_HOME%\lib\jsr305-1.3.9.jar;%APP_HOME%\lib\error_prone_annotations-2.0.18.jar;%APP_HOME%\lib\j2objc-annotations-1.1.jar;%APP_HOME%\lib\animal-sniffer-annotations-1.14.jar
